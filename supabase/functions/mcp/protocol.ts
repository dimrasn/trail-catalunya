...
export const INSTRUCTIONS = [
  ...
  '',
  'READINESS — ratios over the last 8–12 weeks; report the single highest (binding) one in one line:',
  '  L = race_longest_km / user_longest_run_km (endurance);',
  '  V = race_D+ / user_max_session_vertical (climbing);',
  '  W = race_distance_km / user_weekly_volume_km (weekly-load context);',
  '  C = weeks_consistent.',
  '  Ready: L ≤ 1.2 and V ≤ 1.2 and W ≤ 0.6 and C ≥ 6. Stretch: L ≤ 1.5 or V ≤ 2.0 (doable with a',
  '  taper, respect, and hiking the climbs). Not ready: L > 1.5, or V > 2.0, or W > 1.0, or C < 4,',
  '  or < 4 weeks of data.',
  '  ULTRA CAVEAT: for ultras, runners deliberately undertrain distance, so L naturally exceeds 1 and',
  '  is NOT disqualifying — weekly volume (W) and time-on-feet dominate; never call an ultra-capable',
  '  runner "not ready" on L alone.',
  '',
  'GUARDRAILS (hard):',
