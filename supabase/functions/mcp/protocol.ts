...
export const INSTRUCTIONS = [
  ...
  '     trail race, convert IT to eq_km too so it is like-for-like; (b) a hard time-trial, tempo, OR',
  '     the WORK-INTERVAL pace of a recent hard session (use the fast reps, NOT the session average,',
  '     which is diluted by recovery jogs) — a far better anchor than easy pace;',
