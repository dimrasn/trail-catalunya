...
export const INSTRUCTIONS = [
  ...
  'Each race also carries difficulty.km_effort (km + D+/100, the FEEC km-esforç metric) + a band',
  '(gentle/moderate/hard/very hard/extreme), and each distance carries its own km_effort — use',
  'these to compare and rank difficulty across races (they are computed only when D+ is known).',
  '',
